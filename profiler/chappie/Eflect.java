...
import chappie.data.ChappieDataModule;
import chappie.processing.ChappieProcessingModule;
import clerk.Clerk;
...
public final class Eflect {
  ...
  @Component(modules = {EflectDataModule.class, ChappieDataModule.class, ChappieProcessingModule.class, ClerkModule.class, PeriodicSamplingModule.class})
